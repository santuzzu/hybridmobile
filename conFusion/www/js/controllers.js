  ...
  $scope.doLogin = function() {
   ...
   .controller('MenuController', ['$scope', 'menuFactory', 'baseURL',
  	 function($scope, menuFactory, baseURL) {
        ...
        .controller('ContactController', ['$scope', 'contactusFactory', 'baseURL', function($scope, contactusFactory, baseURL) {
			...
			$scope.contactus = contactusFactory.get({id:0});
		...
		.controller('AboutController', ['$scope', 'aboutFactory', 'corporateFactory', 'baseURL', function($scope, aboutFactory, corporateFactory, baseURL) {

			$scope.baseURL = baseURL;
			$scope.aboutus = aboutFactory.get({id:0});
